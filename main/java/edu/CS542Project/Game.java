...
//        resumeButtonPanel.add(exitButton);
    ...
    public void createGameScreen(String player, String weapon, String hat){
//        window.setVisible(false);
        ...
        GamePanel gp = new GamePanel(896,896, player, weapon, hat);
                ...
                case "menu4":
                    switch (mChoice) {
                        ...
                        case "m4j":
                            typeWeapon = "Jagger";
                            System.out.println(player+" "+typeHat+" "+typeWeapon);
                            createGameScreen(player, typeWeapon, typeHat);
                            break;
                    }
                    break;
            }
